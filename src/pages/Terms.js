      ...
      <div class="row">
        ...
        <div class="col-12">
          <div id="intro" class="space-bottom-1">
            ...
            <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("AShop"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
          ...
          <div id="services" class="space-bottom-1">
            ...
            <ul>
              <li class="pb-2">When you register for a AShop account we collect your full name, email address, and account log-in credentials.</li>
              ...
              <li class="pb-2">When you use the "Remember Me" feature of AShop Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
            </ul>

            <p>When you respond to AShop emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call AShop. If you contact us by phone as a AShop User, we may collect additional information in order to verify your identity.</p>
          ...
          <div id="privacy" class="space-bottom-1">
            ...
            <p>AShop's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that AShop can use such data in accordance with our privacy policies.</p>
          ...
          <div id="yourContent">
            ...
            <p>When you upload, submit, store, send or receive content to or through our Services, you give AShop (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to AShop Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
          </div>
